 ...
 * For 1-byte files, this library has roughly a 25 ns/byte overhead compared to plain Haskell `IO` code, which has roughly a 840 ns/byte overhead compared to plain C.
